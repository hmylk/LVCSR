...
#ifndef lint
static char Trellis_Copyright[] = "Copyright (c) 1995-2006 SRI International.  All Rights Reserved.";
static char Trellis_RcsId[] = "@(#)$Header: /home/srilm/devel/lm/src/RCS/Trellis.cc,v 1.22 2006/08/12 06:46:11 stolcke Exp $";
#endif
...
template <class StateT>
StateT
Trellis<StateT>::maxp(unsigned t)
{
    assert(t <= currTime);
    return trellis[t].maxp();
}
